...
class ModifyAccessoryViewController: SmarthomeViewController, HMAccessoryDelegate {
    // MARK: Types
    ...
    */
    ...
    func enableAddButtonIfApplicable() { addButton.isEnabled = home.isAdmin && trimmedName.count > 0
    }
