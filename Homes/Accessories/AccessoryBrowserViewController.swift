...
*/
class AccessoryBrowserViewController: SmarthomeViewController, ModifyAccessoryDelegate, EAWiFiUnconfiguredAccessoryBrowserDelegate, HMAccessoryBrowserDelegate {
    // MARK: Types
